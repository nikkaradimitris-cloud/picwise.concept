...
MANUAL_AMAZON_AFFILIATE_REGISTRY: tuple[AmazonManualAffiliateRecord, ...] = (
    ...
    _record(
        ...
        source=AmazonManualAffiliateSource.AMAZON_SITESTRIPE_MANUAL,
        status=AmazonManualAffiliateStatus.DISABLED,
        quality_status=AmazonManualAffiliateQualityStatus.WEAK_MATCH,
        quality_note="Manual review found no featured Amazon offer available.",
        last_manual_reviewed_at="2026-05-15T14:00:00Z",
        operator_note="Disabled from public results until replaced with a stronger active offer.",
        created_at="2026-05-15T00:00:00Z",
