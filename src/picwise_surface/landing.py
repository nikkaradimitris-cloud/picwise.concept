...
def render_review_safe_landing_page() -> str:
    ...
    return (
        ...
        "<title>PicWise — Shopping Decision Assistant</title>"
        '<meta name="description" content="PicWise is a shopping decision assistant that helps users compare product options, understand trade-offs, and choose more confidently before visiting external providers.">'
        "<style>"
